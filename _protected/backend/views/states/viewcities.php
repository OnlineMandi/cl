		...
		<div class="col-md-12">
			<div class="box">
				<div class="box-body table-responsive">
					<div class="btn-group">
						<?= Html::a('All Cities', ['viewcities',  'state_id' => $model->id], ['class' => 'btn btn-default'.(($this->context->route == 'admin/states/viewcities')?' active':'')]) ?>
						<?= Html::a('Active Cities', ['active-cities',  'state_id' => $model->id], ['class' => 'btn btn-default'.(($this->context->route == 'admin/states/active-cities')?' active':'')]) ?>
						<?= Html::a('Inactive Cities', ['inactive-cities',  'state_id' => $model->id], ['class' => 'btn btn-default'.(($this->context->route == 'admin/states/inactive-cities')?' active':'')]) ?>
					</div>
					<?= Html::a('Add New City', ['add-city',  'id' => $model->id], ['class' => 'btn btn-success pull-right']) ?>
					<p></p>
